...
\begin{enumerate}
  ...
  \item Legen Sie je eine Variable vom Typ \mintinline{c++}{int, char, float, string} an und lassen einen Pointer darauf zeigen. Welche Ausgabe erhalten Sie, wenn Sie die Pointer-Variable mit bzw. ohne den Stern ausgeben lassen?
  \item 
  %ToDo: const Pointer
  \item 
